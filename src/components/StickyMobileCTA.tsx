  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 sm:hidden px-4 pb-4 pt-3 bg-gradient-to-t from-white via-white/95 to-transparent pointer-events-none">
      <div className="pointer-events-auto space-y-2">
        ...
        <button
          onClick={openForm}
          className="pointer-events-auto block w-full text-center bg-gradient-to-r from-red-500 to-red-600 text-white font-bold rounded-full px-6 py-5 shadow-2xl text-base transition-all duration-300 active:scale-95 hover:scale-105 border-none cursor-pointer"
