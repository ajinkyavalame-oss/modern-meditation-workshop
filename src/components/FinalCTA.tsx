    ...
    <section className="py-24 pb-80 px-5 bg-gradient-to-br from-emerald-600 via-teal-600 to-sky-600 relative overflow-hidden">
      ...
      <div className="relative container mx-auto max-w-3xl text-center">
        ...
        <a
          id="register"
          href="#register"
          className="inline-block bg-red-500 text-white font-bold rounded-full px-12 py-5 text-lg shadow-2xl transition-all duration-300 hover:scale-105 hover:bg-red-600 hover:shadow-white/30"
